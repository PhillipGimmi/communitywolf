...
TASK: Generate EXACTLY ${searchResultsCount} safety alerts - one for each search result above.

CRITICAL REQUIREMENTS:
- Generate EXACTLY ${searchResultsCount} alerts (one per search result)
...
Return ONLY valid JSON in this exact format:
{
  "alerts": [
    ...
    // ... continue for ALL ${searchResultsCount} search results
  ]
}`;
